...
import type { GuideProfile } from '../model/types';
...
export function GuideCard({ guide, onBook, bookLabel }: GuideCardProps) {
    ...
    >
      ...
      <Stack gap="md" p={{ base: 'md', md: 'xl' }}>
        ...
        <Stack gap="sm">
          ...
          {onBook ? (
            <>
              <Button color="sun" c="#2c2006" radius="xl" fullWidth onClick={onBook}>
                {resolvedBookLabel}
              </Button>
              <Button
                component="a"
                ...
                rel={guide.contact.href.startsWith('http') ? 'noreferrer' : undefined}
                variant="subtle"
                color="forest"
                radius="xl"
                fullWidth
